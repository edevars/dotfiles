# Generated by Powerlevel10k configuration wizard on 2020-05-01 at 16:12 CDT.
...
# slanted separators, slanted heads, round tails, 2 lines, disconnected, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=030
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=42
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=043
  ...
  #####################################[ vcs: git status ]######################################
  # Version control system colors Github.
   typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=033
   typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=007
  ...
  function my_git_formatter() {
    ...
    local       meta='%6F' # white foreground
    local      clean=''    # remove foreground and its equal to meta
